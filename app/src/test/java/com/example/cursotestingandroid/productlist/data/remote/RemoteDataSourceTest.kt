...
class RemoteDataSourceTest {
    ...
    @Test
    fun givenEmptyJsonResponse_whenGetProducts_thenReturnsEmptyList() =
        runTest {
            // Given
    ...
    @Test
    fun givenValidJasonFile_whenGetProducts_thenReturnsMappedDtos() =
        runTest {
            // Given
    ...
    @Test
    fun givenSerializeProducts_whenGetProducts_thenReturnsMatchesOriginalObject() =
        runTest {
            // Given
            val productResponse =
                ProductResponse(
    ...
    @Test
    fun given404Response_whenGetProducts_thenReturnsNotFoundError() =
        runTest {
            // Given
    ...
    @Test
    fun givenMalformedJson_whenGetProducts_thenReturnsUnknownError() =
        runTest {
            // Given
    ...
    @Test
    fun givenPromotionsRequest_whenGetPromotions_thenCallsCorrectEndpoint() =
        runTest {
            // Given
