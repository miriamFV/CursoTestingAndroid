...
class UpdateCartItemUseCaseTest {
    ...
    @Test
    fun givenZeroQuantity_whenInvoke_thenProductIsRemovedFromCart() = runTest{
        //Given
        val productId = "productId-1"
        val product = product {
            withId(productId)
    ...
    @Test
    fun givenProductNotFound_whenInvoke_thenThrowsNotFoundError() = runTest{
        //Given
        val productId = "productId-1"
    ...
    @Test
    fun givenQuantityHigherThanStock_whenInvoke_thenThrowsInsufficientStockError() = runTest{
        //Given
        val productId = "productId-1"
        val product = product {
            withId(productId)
    ...
    @Test
    fun givenQuantityLowerThanStock_whenInvoke_thenCartIsUpdated() = runTest{
        //Given
        val productId = "productId-1"
        val product = product {
            withId(productId)
