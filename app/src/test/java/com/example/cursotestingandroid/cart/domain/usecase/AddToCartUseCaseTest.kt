...
class AddToCartUseCaseTest {
    ...
    @Test
    fun givenZeroQuantity_whenInvoke_thenThrowsQuantityMustBePositiveError() = runTest {
        //Given
    ...
    @Test
    fun givenNegativeQuantity_whenInvoke_thenThrowsQuantityMustBePositiveError() = runTest {
        //Given
        val fakeCartRepository = FakeCartRepository()
        val fakeProductRepository = FakeProductRepository()
        val useCase = AddToCartUseCase(fakeCartRepository, fakeProductRepository)
    ...
    @Test
    fun givenNoneExistingProduct_whenInvoke_thenThrowsNotFoundError() = runTest {
        //Given
        val fakeCartRepository = FakeCartRepository()
    ...
    @Test
    fun givenInsufficientStock_whenInvoke_thenThrowsInsufficientStockError() = runTest {
        //Given
        val fakeCartRepository = FakeCartRepository()
    ...
    @Test
    fun givenProductWithSufficientStock_whenInvoke_thenProductIsAddedCorrectly() = runTest {
        //Given
        val fakeCartRepository = FakeCartRepository()
        val productId = "id-test-1"
        val product = product {
    ...
    @Test
    fun givenDefaultQuantityInUseCase_whenInvoke_thenOneProductIsAddedCorrectly() = runTest {
        //Given
        val fakeCartRepository = FakeCartRepository()
        val productId = "id-test-1"
        val product = product {
    ...
    @Test
    fun givenZeroQuantity_whenInvoke_thenAnyRepositoryIsCalled() = runTest {
        //Given
    ...
    @Test
    fun givenValidProduct_whenInvoke_thenAddToCartIsCalledWithExpectedValues() = runTest {
        //Given
        val productRepository = mockk<ProductRepository>()
        val cartRepository = mockk<CartRepository>()
