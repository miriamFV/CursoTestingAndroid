...
class GetCartItemsWithPromotionsUseCaseTest {
    ...
    @Test
    fun givenEmptyCart_whenInvoke_thenReturnEmptyList() = runTest {
        //Given
    ...
    @Test
    fun givenExistingCartItemWithActivePromotion_whenInvoke_thenReturnsItemWithPromotion() = runTest {
        //Given
        ...
        val fakePromotionRepository = FakePromotionRepository().apply {
    ...
    @Test
    fun givenCartItemWithoutMatchingProduct_whenInvoke_thenSkipItem() = runTest {
        //Given
    ...
    @Test
    fun givenPromotionEndingExactlyNow_whenInvoke_thenItMustBeIncluded() = runTest {
        //Given
        val productId = "productId-1"
        val product = product {
            withId(productId)
    ...
    @Test
    fun givenExpiredPromotion_whenInvoke_thenItemRemainsButWithoutPromotion() = runTest {
        //Given
        val productId = "productId-1"
        val product = product {
            withId(productId)
    ...
    @Test
    fun givenActivePromotion_whenTimesAdvance_thenFlowEmitsUpdatedListWithoutPromotion() = runTest {
        //Given
        val productId = "productId-1"
        val product = product {
            withId(productId)
