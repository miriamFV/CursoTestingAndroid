...
class GetCartSummaryUseCaseTest {
    ...
    @Test
    fun givenPercentPromotion_whenInvoke_thenCalculateCorrectly() =
        runTest {
            // Given
    ...
    @Test
    fun given3ItemsIn2x1Promotion_whenInvoke_thenOnlyDiscounts1Unit() =
        runTest {
            // Given
            val productId = "productId-1"
            val product =
    ...
    @Test
    fun givenMultipleProductsWithDifferentPromotions_whenInvoke_thenSumsAllCorrectly() =
        runTest {
            // Given
            val now = clock.now()
    ...
    @Test
    fun givenExpiredPromotion_whenInvoke_thenDiscountIsZero() =
        runTest {
            // Given
            val now = clock.now()
            val productId = "productId-1"
    ...
    @Test
    fun givenActivePromotionWhenTimeAdvances_whenInvoke_thenSummaryUpdateAutomatically() =
        runTest {
            // Given
            val now = clock.now()
            val productId = "productId-1"
