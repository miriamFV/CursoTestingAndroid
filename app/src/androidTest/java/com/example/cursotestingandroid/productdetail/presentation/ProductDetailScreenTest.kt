...
class ProductDetailScreenTest {
    ...
    fun givenSuccessState_whenRendered_thenTopBarShowsProductName() {
        ...
        composeRule.onNodeWithTag(TOP_BAR_TITLE)
            .assertIsDisplayed()
    ...
    fun givenProductWithoutStock_whenRendered_thenShowsDisabledNoStockAction() {
        ...
        composeRule.onNodeWithTag(PRODUCT_DETAIL_STOCK_QUANTITY)
            .assertIsDisplayed()
    ...
    fun givenProductWithStock_whenRendered_thenShowsAddToCartButtonWithStockAndStockQuantity() {
        ...
        //Stock text
        val expectedText = composeRule.activity.resources.getQuantityString(
    ...
    fun givenProductWithPercentPromotion_whenRendered_thenShowPercentPromotionInfo() {
        ...
        composeRule.onNodeWithTag(PRODUCT_DETAIL_PERCENT_PROMOTION_STRIKETHROUGH_PRICE).assertIsDisplayed()

        val expectedText = composeRule.activity.getString(
            R.string.product_detail_screen_percent_off,
            percentPromo.percent.toInt()
        )
        composeRule.onNodeWithTag(PRODUCT_DETAIL_PERCENT_PROMOTION_LABEL)
            .assertIsDisplayed()
            .assertTextEquals(expectedText)
    }
    ...
    fun givenProductWithBuyXPayYPromotion_whenRendered_thenShowBuyXPayYPromotionInfo() {
        ...
        composeRule.onNodeWithTag(PRODUCT_DETAIL_BUYXPAYY_PROMOTION_LABEL)
            .assertIsDisplayed()
            .assertTextEquals(expectedText)
    }
    ...
    fun givenProductWithoutPromotion_whenRendered_thenShowNormalProductInfo() {
        ...
        composeRule.onNodeWithTag(PRODUCT_DETAIL_PRODUCT_NAME)
            .assertIsDisplayed()
            .assertTextEquals(bread().name)

        composeRule.onNodeWithTag(PRODUCT_DETAIL_PRODUCT_CATEGORY)
            .assertIsDisplayed()
