...
class PromotionDaoTest {
    ...
    @Test
    fun givenTwoPromotions_whenInsertAndGetAllPromotions_thenReturnsAllPromotions() = runTest {
        //Given
        val promotion1 = promotionEntity { withId("promo1"); withPercent(10)  }
        val promotion2 = promotionEntity { withId("promo2"); withPercent(20)  }
    ...
    @Test
    fun givenMultiplePromotions_whenClearPromotions_thenDatabaseIsEmpty() = runTest {
        //Given
        val promotion1 = promotionEntity { withId("promo1");  }
        val promotion2 = promotionEntity { withId("promo2");  }
        val promotion3 = promotionEntity { withId("promo3");  }
    ...
    @Test
    fun givenInsertedPromotions_whenReplaceAllPromotions_thenOnlyNewPromotionsRemain() = runTest {
        //Given
        val oldPromotion1 = promotionEntity { withId("promo1"); withPercent(20) }
        val oldPromotion2 = promotionEntity { withId("promo2"); withPercent(10)}
        val oldPromotion3 = promotionEntity { withId("promo3"); withPercent(50) }
        val oldPromotions = listOf(oldPromotion1, oldPromotion2, oldPromotion3)
        promotionDao.insertPromotions(oldPromotions)

        //When
        val promotion1 = promotionEntity { withId("promo1"); withPercent(10) }
        val promotion2 = promotionEntity { withId("promo2"); withPercent(60) }
    ...
    @Test
    fun givenFlowSubscribed_whenInsertAfterSubscribe_thenEmitUpdatedList() = runTest {
        //Given
