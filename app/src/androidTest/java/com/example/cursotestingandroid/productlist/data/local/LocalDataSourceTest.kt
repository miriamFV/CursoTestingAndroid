...
class LocalDataSourceTest {
    ...
    @Test
    fun givenSavedProducts_whenGetProductsByIds_thenReturnsCorrectProducts() =
        runTest {
            // Given
            val products =
                listOf<ProductEntity>(
    ...
    @Test
    fun givenExistingCartItem_whenUpdateCartItem_thenReturnsSuccessAndCartItemUpdated() =
        runTest {
            // Given
            val originCartItem =
                cartItemEntity {
    ...
    @Test
    fun givenMultipleCartItem_whenDeleteCartItem_thenReturnsSuccessAndCartItemListIsUpdated() =
        runTest {
            val cartItem1 =
                cartItemEntity {
                    withProductId("id1")
    ...
    @Test
    fun givenMultipleCartItems_whenClearCart_thenReturnsSuccessAndCartIsEmpty() =
        runTest {
            // Given
            val cartItem1 =
                cartItemEntity {
