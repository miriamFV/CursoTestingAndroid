...
class CartRepositoryImplTest {
    ...
    @Test
    fun givenEmptyCart_whenAddToCart_thenGetCartItemsContainsItem() = runTest {
        //When
    ...
    @Test
    fun givenCartWithProducts_whenAddAnExistingItem_thenQuantityIsUpdated() = runTest {
        //Given
    ...
    @Test
    fun givenCartWithProducts_whenGetCartItems_thenReturnsCorrectProducts() = runTest {
        //Given
        cartRepository.addToCart("p1", 2)
    ...
    @Test
    fun givenCartWithProducts_whenGetCartItemById_thenReturnsCorrectProduct() = runTest {
        //Given
        cartRepository.addToCart("p1", 2)
        cartRepository.addToCart("p2", 4)
        //When
    ...
    @Test
    fun givenCartWithProducts_whenUpdateQuantity_thenQuantityIsUpdated() = runTest {
        //Given
        cartRepository.addToCart("p1", 1)
        //When
    ...
    @Test
    fun givenCartWithProducts_whenUpdateNonExistingItem_thenThrowsNotFoundError() = runTest {
        //Given
        cartRepository.addToCart("p1", 2)
    ...
    @Test
    fun givenCartWithProducts_whenRemoveAnExistingItem_thenCartIsUpdated() = runTest {
        //Given
        cartRepository.addToCart("p1", 2)
        cartRepository.addToCart("p2", 1)
        // When
    ...
    @Test
    fun givenItemInCart_whenRemoveFromCart_thenCartIsEmpty() = runTest {
        //Given
        cartRepository.addToCart("p1", 2)
        // When
    ...
    fun givenEmptyCart_whenRemoveFromCart_thenThrowsNotFound() = runTest {
        cartRepository.removeFromCart("p1")
    }

    @Test
    fun givenCartWithProducts_whenRemoveNonExistingItem_thenThrowsNotFoundError() = runTest {
        //Given
        cartRepository.addToCart("p1", 2)
        cartRepository.addToCart("p2", 1)
        //When
    ...
    @Test
    fun givenCartWithProducts_whenClearCart_thenCartIsEmpty() = runTest {
        //Given
        cartRepository.addToCart("p1", 2)
        cartRepository.addToCart("p2", 1)
        // When
