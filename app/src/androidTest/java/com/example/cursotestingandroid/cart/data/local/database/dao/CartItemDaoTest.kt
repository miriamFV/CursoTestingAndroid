...
class CartItemDaoTest {
    ...
    @Test
    fun givenEmptyDatabase_whenGetAllCartItems_thenEmitsEmptyList() =
        runTest {
    ...
    @Test
    fun givenInsertedCartItem_whenGetCartItemById_thenReturnsCartItem() =
        runTest {
            // Given
            val productId = "productId"
            val quantity = 3
    ...
    @Test
    fun givenEmptyCart_whenGetCartItemById_thenReturnsNull() =
        runTest {
            // Given
            val productId = "productId"
            // When
    ...
    @Test
    fun givenExistingItem_whenUpdateItemQuentity_thenReturnsQuantityIsUpdated() =
        runTest {
            // Given
            val productId = "productId"
            val cartItemEntity =
    ...
    @Test
    fun givenMultipleItems_whenClearCart_thenCartBecomesEmpty() =
        runTest {
            // Given
